...
Pod::Spec.new do |s|
  s.name             = 'Rohan123'
  s.version          = '0.1.0'
  s.summary          = 'A short description of Rohan123.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/rohanmoradiya/Rohan123'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'rohanmoradiya' => 'rohanmoradiya@gmail.com' }
  s.source           = { :git => 'https://github.com/rohanmoradiya/Rohan123.git', :tag => s.version.to_s }
